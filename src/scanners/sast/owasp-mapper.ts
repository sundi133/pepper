...
const CWE_TO_OWASP_MAP: Record<string, { owasp2024: string; owaspApi?: string; owaspLlm?: string }> = {
  "CWE-79": { owasp2024: "A03:2021 Injection", owaspApi: "A01:2023 Broken Object Level Authorization" },
  ...
  "CWE-113": { owasp2024: "A05:2021 Broken Access Control" },
  "CWE-191": { owasp2024: "A04:2021 Insecure Design" },
  "CWE-200": { owasp2024: "A01:2021 Broken Access Control" },
  "CWE-209": { owasp2024: "A06:2021 Vulnerable and Outdated Components" },
  ...
  "CWE-384": { owasp2024: "A08:2021 Software and Data Integrity Failures" },
  "CWE-400": { owasp2024: "A10:2021 Server-Side Request Forgery (SSRF)" },
...
export function calculateExploitabilityScore(
  ...
  const finalScore = (confidenceWeight + severityWeight) / 2;
