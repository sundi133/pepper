                    ...
                    <div className="text-xs text-gray-600 space-y-1">
                      {webhook.secretKey === "github" && (
                        <>
                          ...
                          <p>2. Paste URL below (application/json)</p>
                          <p>3. Add Secret from below</p>
                          <p>4. Enable Pull requests & Pushes</p>
                        </>
                      )}
                      {webhook.secretKey === "gitlab" && (
                        <>
                          <p>1. Settings → Webhooks</p>
                          <p>2. Paste URL below</p>
                          <p>3. Check Merge requests & Push events</p>
                          <p>4. Add Secret token from below</p>
                        </>
                      )}
                      {webhook.secretKey === "bitbucket" && (
                        <>
                          <p>1. Repository settings → Webhooks</p>
                          <p>2. Paste URL below</p>
                          <p>3. Enable Push, PR created/updated</p>
                          <p>4. Add Secret from below</p>
                        </>
                      )}
                      {webhook.secretKey === "azure" && (
                        <>
                          <p>1. Project settings → Service hooks</p>
                          <p>2. Create subscription → Web Hooks</p>
                          <p>3. Paste URL below</p>
                          <p>4. Add Secret as password</p>
                        </>
                      )}
                    </div>
                  </div>
